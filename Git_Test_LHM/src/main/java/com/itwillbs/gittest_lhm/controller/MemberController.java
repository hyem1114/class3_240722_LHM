...
import com.itwillbs.gittest_lhm.service.MemberService;
...
public class MemberController {
	...
	// "MemberJoin" 매핑 - GET
	// => 회원가입 폼 페이지 포워딩
	@GetMapping("MemberJoin") //<a href="MemberLogin">
...
//		BCryptPasswordEncoder passwordEncoder = new BCryptPasswordEncoder();
		...
		// 실패 시 : result_process/fail.jsp 페이지 포워딩("msg" 속성값으로 "회원가입 실패!" 전달)
		if(insertCount > 0) {
